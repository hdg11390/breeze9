                    ...
                    <div class="container mx-auto px-5 py-4 ">
                        <div class=" flex justify-center flex-wrap -m-4 ">
                            ...
                            <div class="flex flex-col items-center lg:flex-row lg:w-3/5">
                              ...
                              <div class=" text-lg text-gray-900 font-semibold px-6  whitespace-nowrap self-center lg:basis-3/6">
                                {{ $dog->regName }}
                              </div>
                              <div class="text-lg text-gray-900 font-semibold px-6 self-center whitespace-nowrap lg:basis-2/6">
