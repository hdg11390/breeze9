<x-app-layout>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="bg-white ">
              <p class="px-20 pt-8 prose-lg">I'd like to introduce my current female Labs to you. Our girls are all well socialized, friendly, sound bitches, who love to take turns coming inside for a frolic, a snooze on the couch, an extra treat and lots of lovin's from us. Usually as they balance themselves on my lap in the lazy boy (girl) chair! I am very proud of their temperament, their kind ways and winning expressions. Most visitors to our home are impressed with their looks, brains and spirit.</p>
