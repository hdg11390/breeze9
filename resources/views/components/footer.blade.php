...
<div class="flex flex-row flex-wrap  bg-staghorn-400 rounded text-white ">
  <div class="basis-1/3 text-center p-4 text-sm ">
                    ...
                    <li class="hover:text-staghorn-500 hover:font-bold"><a href="rainbow2.php">Rainbow Bridge Girls</a></li>
                  </ul>
  </div>

  <div class="basis-1/3 text-center mx-auto ">
    <div class="flex justify-center items-center pt-4">
      <img src="/images/3colours.png" alt="" class="text-center justify-center" >
    </div>

  <div class="flex justify-center items-center p-3">
      <a  href="https://whc.ca/green-powered/?aff=3153&amp;gbid=2en" onclick="window.open(this.href, 'popupWindow', 'width=450, height=538, status=no, scrollbars=no, menubar=no'); return false;"><img src="https://s.whc.ca/badges/green-badge-2.svg" width="88" class="content-center" alt="Green Hosting Badge" ></a><br>
  </div>

  <p class="text-xs pb-4">Copyright &copy; {{ now()->year }} Staghorn Reg'd Labradors. All rights reserved.</p>      
    ...
    <div class="basis-1/3 text-center pt-4 pr-8 text-sm">
      <ul>
          ...
          <li class="hover:text-staghorn-500 hover:font-bold"><a href="adults.php">Adults Available</a></li>
          <li class="hover:text-staghorn-500 hover:font-bold"><a href="contact/contact.html">Contact Us</a></li>
      </ul>
    </div>
</div>